...
Etudiant * get_info(Etudiant * L){
    ...
    if (fp == NULL) {
        ...
        int age = (rand() % 3 + 18);
        /*random generation of numbers between 18 and 20*/
...
void chercher_N_P(Etudiant *L)
{
    ...
    if(c == 0)    printf("Desole, l'etudiant que vous avez chrché n'exist pas dans la liste des etudiants G.I S1 2022.\n");
}
...
void cherchCNE(Etudiant *L)
{
    ...
    if(a == 0)    printf("Desole, l'etudiant que vous avez chrche n'exist pas dans la liste des etudiants G.I S1 2022.\n");
